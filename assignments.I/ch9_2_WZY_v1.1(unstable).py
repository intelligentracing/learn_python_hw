...
bishop_moves = [[random.randint(-(board_size[0]-current_move[0]+1),board_size[0]-current_move[0]+1),\
                 random.randint(-(board_size[0]-current_move[0]+1),board_size[1]-current_move[1]+1)]]
