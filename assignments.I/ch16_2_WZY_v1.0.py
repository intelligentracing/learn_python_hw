...
while True:
    ...
    line=np.array([0.,256.])
    for i in range (12):
        l=rotationMatrix(30*i).dot(line)
        plt.arrow(256,256,l[0],l[1],head_width=0, head_length=0, color = 'black')
    plt.xticks(np.arange(0,512,512), [" "])
    plt.yticks(np.arange(0,512,512), [" "])
    plt.pause(0.1)
    plt.clf()
